...
class alertBox {
    ...
    this.render = function (data) {
        ...
        document.getElementById('alertboxfooter').innerHTML = '<button class="alert-btn" id="alertBoxBtn">' + data.btnTitle + '</button>';
        document.getElementById("alertBoxBtn").addEventListener("click", this.btn)
        if (data.themeColor) {
...
export var alertbox = new alertBox();